...
@Component({
  selector: 'app-colleague-checkout',
  templateUrl: './colleague-checkout.page.html',
  styleUrls: ['./colleague-checkout.page.scss'],
})
export class ColleagueCheckoutPage implements OnInit {
  image: any = '';
  staff: any;
  staffId: any;
  staffEmail: any;
  ...
  constructor( private camera: Camera,
    public alertController: AlertController,  private router: Router, private nativeStorage: NativeStorage,
    public loadingController: LoadingController, private staffService: StaffService,
    private geolocation: Geolocation,
    private nativeGeocoder: NativeGeocoder, public toastCtrl: ToastController) { }
